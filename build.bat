...
if not exist "public\assets\images\members\payment" mkdir "public\assets\images\members\payment"
...
del /F /Q "public\assets\images\members\payment\*" 2>nul
...
xcopy /Y /E "assets\images\members\payment" "public\assets\images\members\payment" > nul
